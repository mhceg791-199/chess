      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground dark:text-zinc-400">
            ...
            <Link href="/login" className="text-chess-bronze hover:underline font-medium dark:text-white">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-zinc-900 rounded-lg border border-border dark:border-zinc-800 p-6 space-y-4 shadow-sm transition-colors">
          ...
          <div>
            <label htmlFor="name" className="block text-sm font-medium text-chess-charcoal dark:text-zinc-300 mb-1">
              Full name
            </label>
            <input
              id="name"
              ...
              className="w-full px-3 py-2 bg-transparent dark:bg-zinc-950 border border-border dark:border-zinc-800 rounded-sm text-sm text-chess-charcoal dark:text-zinc-200 placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-chess-bronze/30 focus:border-chess-bronze transition-all"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 pr-10 bg-transparent dark:bg-zinc-950 border border-border dark:border-zinc-800 rounded-sm text-sm text-chess-charcoal dark:text-zinc-200 placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-chess-bronze/30 focus:border-chess-bronze transition-all"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-chess-charcoal dark:text-zinc-300 mb-1">
              Confirm password
            </label>
            <input
              id="confirmPassword"
